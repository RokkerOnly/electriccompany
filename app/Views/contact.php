        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card h-100 text-center p-4 feature-item">
                    ...
                    <p class="text-muted mb2"><strong>General:</strong><br>info@Puihahaelectric.com</p>
                    <p class="text-muted mb0"><strong>Emergency:</strong><br>emergency@Puihahaelectric.com</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="card h-100 text-center p-4 feature-item">
...
isset($validation['name']) ? 'is-invalid' : '' ?>" id="name" name="name" value="<?= old('name') ?>" required>
...
'is-invalid' : '' ?>" id="service_type" name="service_type" required>
...
?>>Other</option>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea
                                        class="form-control <?= isset($validation['message']) ? 'is-invalid' : '' ?>"
                                        id="message" name="message" rows="5" placeholder="Please describe your electrical project, including location,
...
<section class="section-padding">
    <div class="container">
        ...
        <div class="text-center mt-5">
            <p class="text-muted">Don't see your area listed? <a href="#contactForm"
                    class="textprimary-custom fw-semibold">Contact us</a> to check if we service your location.</p>
        </div>
    </div>
</section>
